...
Cabe mencionar que a lo largo de esta unidad (y en este sitio) se mostrará la manera de abordar problemas estadísticas utilizando las herramientas disponibles en el lenguaje **R**, por medio de la interfaz de **RStudio**. Si se desea trabajar con LibreOffice Calc, se puede acceder [aquí](UC1.html). Si se desea abordar el contenido desde el enfoque de **Google Sheets**, el acceso está [aquí](UG1.html). Cada peculiaridad de dichas aplicaciones se abordará en su respectivo momento.
